...
def select_series_title_with_most_human_characters
  "SELECT series.title FROM series INNER JOIN characters ON series.id = characters.series_id WHERE character.species = 'human';" #COUNT(characters.species) HAVING characters.species = 'human' ORDER BY DESC LIMIT 1;"
end
